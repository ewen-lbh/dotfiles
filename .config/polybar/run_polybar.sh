...
python ~/.config/polybar/spotify-metadata-receiver.py localhost 8887 '{elapsed/duration*100:2.0f}% {i("♥ ", liked)}{i("¹↷", loop)}{i("⇄", shuffle)}{artist} — {title}' ~/.config/polybar/spotify-metadata.txt &
